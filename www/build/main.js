...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_forcejs__ = __webpack_require__(268);
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.loadUsers = function () {
        var _this = this;
        var oauth = __WEBPACK_IMPORTED_MODULE_2_forcejs__["OAuth"].createInstance();
        oauth.login()
            .then(function (oauthResult) {
            var service = __WEBPACK_IMPORTED_MODULE_2_forcejs__["DataService"].createInstance(oauthResult);
            service.query('SELECT Id, Name FROM User LIMIT 10')
                .then(function (response) {
                _this.users = response.records;
            });
        });
    };
    HomePage = __decorate([
